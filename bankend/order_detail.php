 			...
 			<table class="table table-bordered">
 				<thead>
 					<tr>
 						<td colspan="10" rowspan="4" style="border-width: 3px">
 							<h5 class="text-center">YARGYI ONLINE SHOPPING</h5>
 							<h6 class="text-center">Sanchoung</h6>
 							<h6 class="text-center">Kyon Taw Road,Yangon.</h6>
 							<h6 class="text-center py-3">Tel : 09-784567750</h6>
 						</td>
 				...
 				<tbody>
 					<tr>
 						...
 						<td colspan="2" class="border-0"><h6>: <?php echo $orderdetails[0]['user_name'] ?></td></h6>
 						<td colspan="2" class="border-0"><h6>Date</td></h6>
 						<td colspan="1" class="border-0"><h6  class="text-center">:</td></h6>
 						<td colspan="2" class="border-0" ><h6 class="text-left"><?php echo $orderdetails[0]['orderdate'] ?></td></h6>
 					</tr>
 					<tr>
 						<td colspan="3" class="border-0"><h6>Voucher</h6></td>
 						<td colspan="7" class="border-0"><h6>: <?php echo $orderdetails[0]['voucherno'] ?></h6></td>
 					</tr>
 					<tr>
 					...
 					foreach ($orderdetails as $item_order) {
 						$qty=$item_order['qty'];
 					...
 					<tr>
 						...
 						<td colspan="2" class="text-right border-0" ><?php echo $orderdetails[0]['total'] ?></td>
 					</tr>
 					<tr>
