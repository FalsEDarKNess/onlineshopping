...
<html>
<head>
	<title>YarGyi Online Store</title>
...
<body>
	...
	<nav class="navbar navbar-expand-md navbar-light bg-light menu py-3">
		<div class="container">
			<a href="index.html" class="navbar-brand">Yar Gyi Online Store</a>
				...
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item dropdown">
				        ...
				        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
				          ...
				          <a class="dropdown-item" href="bankend/logout.php">Logout</a>
				      ...
				      ?>
					<li class="nav-item"><a href="bankend/login.php" class="nav-link">LOGIN</a></li>
					<li class="nav-item"><a href="bankend/register.php" class="nav-link">REGISTER</a></li>
				<?php } ?>
