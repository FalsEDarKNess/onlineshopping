...
<div class="container-fluid">
		<div class="row">
			...
			<div class="col-6 col-md-4 text-center">
				...
				<p class="text-muted">Hotline: <span class="text-danger">09-784567750</span></p>
			</div>
			<div class="col-6 col-md-4 text-center">
				<span class="fa-stack fa-2x">
					<i class="fas fa-circle fa-stack-2x"></i>
	...
	<footer class="text-center mt-5 bg-light">
		<div class="container text-center py-2 pt-4">
			...
			<p>
				Copyright &copy; yargyishop.com | Design by <a href="http://heinminhtet.com" target="_blank">YAR_GYI</a>
			</p>
		</div>
	</footer>
